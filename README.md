...
[![Build Status](https://travis-ci.com/ducksoso/protoreflect.svg?branch=master)](https://travis-ci.com/github/ducksoso/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/ducksoso/protoreflect)](https://goreportcard.com/report/github.com/ducksoso/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/ducksoso/protoreflect?status.svg)](https://godoc.org/github.com/ducksoso/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/ducksoso/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/desc)*

```go
import "github.com/ducksoso/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/desc/protoparse)*

```go
import "github.com/ducksoso/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/desc/protoprint)*

```go
import "github.com/ducksoso/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/ducksoso/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/dynamic)*

```go
import "github.com/ducksoso/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/ducksoso/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/ducksoso/protoreflect/grpcreflect)*
