...
type Bar struct {
	...
	Baz []Foo `protobuf:"varint,1,rep,name=baz,enum=ducksoso.protoreflect.desc.Foo" json:"baz,omitempty"`
}
...
var file_pkg_desc_test_pkg_proto_goTypes = []interface{}{
	(Foo)(0),    // 0: ducksoso.protoreflect.desc.Foo
	(*Bar)(nil), // 1: ducksoso.protoreflect.desc.Bar
}
var file_pkg_desc_test_pkg_proto_depIdxs = []int32{
	0, // 0: ducksoso.protoreflect.desc.Bar.baz:type_name -> ducksoso.protoreflect.desc.Foo
