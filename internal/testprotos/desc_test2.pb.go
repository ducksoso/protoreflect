...
import (
	...
	nopkg "github.com/ducksoso/protoreflect/internal/testprotos/nopkg"
	pkg "github.com/ducksoso/protoreflect/internal/testprotos/pkg"
...
type Whatchamacallit struct {
	...
	Foos *pkg.Foo `protobuf:"varint,1,req,name=foos,enum=ducksoso.protoreflect.desc.Foo" json:"foos,omitempty"`
}
...
var file_desc_test2_proto_goTypes = []interface{}{
	...
	(pkg.Foo)(0),                      // 8: ducksoso.protoreflect.desc.Foo
	(*pkg.Bar)(nil),                   // 9: ducksoso.protoreflect.desc.Bar
...
var file_desc_test2_proto_depIdxs = []int32{
	...
	8,  // 6: testprotos.Whatchamacallit.foos:type_name -> ducksoso.protoreflect.desc.Foo
	9,  // 7: testprotos.Whatzit.gyzmeau:type_name -> ducksoso.protoreflect.desc.Bar
